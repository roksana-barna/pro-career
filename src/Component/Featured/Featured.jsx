    ...
    return (
        < div>
            <div className='border border-slate-400 mr-10 mt-10 p-5'>
                ...
                <button className='border border-blue-400 px-2 rounded py-1 text-blue-500'>{job.RemoteOrOnsite}</button>
                ...
                <MapPinIcon className="h-4 w-4 text-blue-500 mt-5" /><p className='font-normal p-4'> 
                    ...
                    < CurrencyDollarIcon className="h-4 w-4 mt-5 text-blue-500" /><p className='mt-4'> Salary:{job.Salary}</p>
                </div>
